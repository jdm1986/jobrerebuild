                ...
                <div class="benefits"><h4>Compare features</h4>
                    <ul>
                        ...
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            ...
                            <div class="tooltip hide">
                                <div><p>The PRO version comes with advanced grid functions like multiple styles, AJAX filtering, pagination, lazy load via AJAX, lightbox support etc.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/portfolio-grid-pro/">Live Demo</a></p></div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
                            <div class="text">Post Blocks!</div>
                            <div class="tooltip hide">
                                <div><p>Present your blog posts, events, news items or portfolio in a dozen creative ways. Comes with AJAX filtering, pagination and load more features to help visitors navigate your entire collection of blog posts or custom post types and their categories without reloading the page.&nbsp;<a target="_blank" href="https://www.livemeshthemes.com/beaver-builder-addons/posts-block/">Live Demo</a></p>
                                </div>
                            </div>
                        </li>
                        <li><span class="help dashicons dashicons-editor-help"></span>
    ...
    <div class="panels">
        ...
        <div id="panel" class="panel">
            ...
            <div id="upgrade-panel" class="panel-left visible">
                ...
                <ul>
                    <li><a href="https://www.livemeshthemes.com/beaver-builder-addons/posts-block/" title="Livemesh Post Blocks" target="_blank">Post Blocks</a> - Present your blog posts, events, news items or portfolio
